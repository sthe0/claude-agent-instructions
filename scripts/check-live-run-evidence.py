...
CEILING_CONST = {
    ...
    ("hook-resolution-reminder.py", "landing_discipline"): "_LANDING_DISCIPLINE_JUDGE_BUDGET_S",
    ("hook-guard-committed-data.py", "committed_data"): "_COMMITTED_DATA_JUDGE_BUDGET_S",
}
