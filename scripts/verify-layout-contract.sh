...
require_file "$REPO/scripts/hook-answer-delivery-reminder.py"
require_file "$REPO/scripts/hook-arc-mount-search-guard.py"
require_file "$REPO/scripts/hook-ask-defer-timer.py"
require_file "$REPO/scripts/hook-engine-start.py"
require_file "$REPO/scripts/hook-experience-record-reminder.py"
require_file "$REPO/scripts/hook-guard-destructive-rm.py"
require_file "$REPO/scripts/hook-instructions-refresh-due.py"
...
require_file "$REPO/scripts/hook-scope-conflict.py"
require_file "$REPO/scripts/hook-scope-track.py"
require_file "$REPO/scripts/hook-self-improvement-reminder.py"
require_file "$REPO/scripts/hook-sigma-sentinel-due.py"
...
require_file "$REPO/scripts/hook-ask-text-split.py"
require_file "$REPO/scripts/hook-escalation-diagnosis-gate.py"
require_file "$REPO/scripts/hook-guard-serving-checkout-offmain.py"
