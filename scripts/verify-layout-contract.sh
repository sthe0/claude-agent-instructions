...
require_file "$REPO/scripts/hook-burn-rate-guard.py"
...
require_file "$REPO/scripts/hook-multi-mount-search-guard.py"
...
require_file "$REPO/scripts/hook-term-neutrality.py"
