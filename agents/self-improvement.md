...
description: "Агент самоулучшения: анализ сессий, ошибок и корректировок пользователя; предложения по агентам, CLAUDE.md, скиллам, инструментам и инфраструктуре (в т.ч. git для инструкций, программы, интеграции)."
...
1. Пользователь указывает на ошибку агента или неверный совет.
2. Эмпирическая проверка опровергла вывод в текущей сессии.
3. Длинное расследование завершено — что улучшить в системе, а не только «запомнить факт».
4. Пользователь просит улучшить агентов, инструкции, workflow.
5. Повторяющийся паттерн в нескольких сессиях (делегируй **manager** для обзора сессий).
