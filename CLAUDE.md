...
**Порядок в ходе с корректировкой:** как только понял замечание — запусти `Task` **self-improvement** (можно параллельно с тактическим фиксом). **Не завершай ход** ответом пользователю, пока self-improvement не запущен — даже если фикс уже применён.

Повторная корректировка по той же теме или вопрос «почему не сработало правило X» / «почему не было self-improvement» — **обязательный** триггер: снова self-improvement и усиление формулировки в инструкциях.
