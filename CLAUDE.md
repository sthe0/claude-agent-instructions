...
- **разбор сессии**, ретроспектива, **несколько тикетов** или мультишаговая координация — **manager до planner** (manager маршрутизирует planner/yandex-developer).
...
- **manager** — **обязателен** при затруднениях (§ выше); мультишаговые задачи и разбор сессий; маршрутизация planner + yandex-developer; цикл исследование→критика→переплан→действие.
