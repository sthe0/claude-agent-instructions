...
- Where it arose: designing distribution + conflict-reconciliation for the agent instruction system (CLAUDE.md + skills + memory leaves) across internal (an internal tracker) and external (GitHub/Linear/Jira) developers.
