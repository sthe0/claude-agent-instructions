...
| [0005](0005-activity-act-functional-places.md) | The activity-act functional places the engine was missing (8 categorical defects) | Accepted (2026-08-16) — implemented across plan.py/state.py/submission.py/gates.py; corpus migration and 8 in-flight engine defects deliberately left open |
| [0006](0006-premise-invalidation-scope.md) | Premise invalidation scope | Accepted (2026-08-18) — documentation-only record of four invariants from stages 2–8 of `premise-loop-determinize-r2` |
