...
- [The crutch registry](operations/crutch-registry.md) — mechanically enumerating regex-crutches and prose-crutches, classifying them into a checked-in registry, and re-checking on every run so a fixed instance cannot silently regress.
